                ...
                <v-card class="member-card">
                    <v-card-text>
                        <v-layout class="card-header align-center">
                            <v-icon small class="active-status" v-if="is_online(item)" title="Online" color="success">mdi-check-circle</v-icon>
                            <v-icon small class="active-status" v-else title="Offline">mdi-circle</v-icon>
                            <span>{{ item.job_title | ucwords }}</span>
                            <v-menu bottom>
                                <template v-slot:activator="{ on }">
                                    <v-icon small fab class="settings" v-on="on">settings</v-icon>
                                </template>
                                <v-list dense>
