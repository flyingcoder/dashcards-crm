<template>
    <v-row no-gutters>
        <v-col md="12">
            ...
            <v-list three-line flat class="comments-wrapper" :max-height="maxHeight">
                <template v-for="(item, index) in items">
                    <v-list-item :key="item.id" @mouseover="hover = true" @mouseleave="hover = false">
                        <v-list-item-avatar>
        ...
        <v-col md="12">
            <v-row>
                ...
                <v-col md="10" class="pr-3 pl-4">
                    <rich-editor placeholder="Enter a comment" ref="editor" v-model="comment" :uploadApi="uploadApi"></rich-editor>
                    <v-btn :loading="btnloading" @click="addComment" tile :disabled="isEmptyComment" color="gray">
        ...
        <DeleteDialog ref="delete_comment_dialog" title="Delete Comment" text-content="Are you sure you want to delete this comment?" @delete="confirmed_delete_comment" />
    </v-row>
</template>
