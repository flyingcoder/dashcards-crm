<template>
    <v-row no-gutters class="comments-section">
            ...
            <v-row>
                ...
                <v-col grow class="pr-3 pl-4">
                    <div class="comment-field">
                        <Editor v-model="comment" :componentKey="counterReset" :hasFloatingTools="false"
                                :content="comment" placeholder="Enter a comment"
                        />
        ...
        <DeleteDialog ref="delete_comment_dialog" title="Delete Comment"
