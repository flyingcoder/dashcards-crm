      ...
      <v-card class="pa-0">
        ...
        >
          <v-row no-gutters>
            ...
            <v-btn text class="mr-1" outlined color="#657186" @click="cancel"
              >Cancel</v-btn
            >
            <v-spacer></v-spacer>
            <v-btn text class="mr-1" outlined color="#657186" @click="clear"
              >Clear</v-btn
            >
            <v-spacer></v-spacer>
            <v-btn text class="mr-1" outlined color="primary" @click="save"
              >Save</v-btn
            >
          </v-row>
        </v-time-picker>
