    ...
    <v-card>
            ...
            <v-row>
              ...
              <v-col md="9">
                ...
                <v-list-item-subtitle class="body-2"
                  ...
                  {{ user.job_title | ucwords }}</v-list-item-subtitle
                >
              </v-col>
            </v-row>
          </v-list-item-content>
      ...
      <v-card-actions>
        <v-btn @click="navigate_to_profile" text small class="caption"
          ><v-icon small left>person</v-icon> View Profile</v-btn
        >
        <v-btn @click="navigate_to_email" text small class="caption"
          ><v-icon small left>email</v-icon> Email</v-btn
        >
        <v-btn @click="navigate_to_chat" text small class="caption"
          ><v-icon small left>message</v-icon> Chat</v-btn
        >
      </v-card-actions>
    </v-card>
  </v-menu>
