            ...
            <v-card flat>
                ...
                <v-tabs-items v-model="tab">
                    <v-tab-item :value="'url'">
                        <v-card flat>
                            <v-card-text>
                                ...
                                <v-text-field label="Image URL" placeholder="https://" v-model.trim="url" type="url" flat outlined hide-details color="#657186"></v-text-field>
                            </v-card-text>
                        </v-card>
                    </v-tab-item>
                    <v-tab-item :value="'upload'">
                        <v-card flat>
                            <v-card-text>
                                <CustomDropzone ref="dropzone" :duplicateCheck="true" acceptedFiles="image/*" :options="dropzoneOptions" :useCustomSlot="true" dictFileTooBig="File too big" dictInvalidFileType="Invalid file type" @success="fileChange" @file-added="file_added"></CustomDropzone>
                            </v-card-text>
                        </v-card>
                    </v-tab-item>
                </v-tabs-items>
