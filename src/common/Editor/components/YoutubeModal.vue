        ...
        <template #content>
            <v-row no-gutters class="custom-dialog">
                <v-col xs="12" md="12">
                    ...
                    <v-text-field filled label="Youtube URL" clearable @click:clear="embedUrl = null" v-model.trim="url" type="url" hide-details color="#657186"></v-text-field>
                </v-col>
                <v-col md="12" class="mt-2" v-if="youtubeID">
                    <iframe :src="embedUrl" :height="300" :key="ckey" class="fullwidth"></iframe>
                </v-col>
            </v-row>
        </template>
    </CustomDialog>
