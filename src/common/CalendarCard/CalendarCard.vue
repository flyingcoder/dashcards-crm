<template>
    <div class="calendar-card">
        <div class="calendar__content">
            ...
            <AddParticipantDialog ref="add_participant_dialog" :event="eventToEdit" @participants-refresh="refreshParticipants"></AddParticipantDialog>
            <dash-card title="Calendar" @close="$emit('close')" class="calendar__content" :viewMoreBtn="false" :view-more-link="viewMoreLink" @view-more="load_more_events" :dashboard="dashboard" @expand="expand">
                <div class="calendar__inner_content" slot="content">
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col md="6">
                            <v-btn block depressed large text @click="$router.push({ name: 'calendar' })">
                                <v-icon left>mdi-calendar-arrow-right</v-icon> View Events
                            </v-btn>
