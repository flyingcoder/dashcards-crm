<template>
    <div class="timeline-card">
        <div class="timeline__content">
            <dash-card title="Timeline" :dashboard="dashboard" @close="$emit('close')" :view-more-link="viewMoreLink" :viewMoreBtn="enableViewMore" @view-more="load_more_timeline" @expand="expand">
                <template v-slot:content>
                    ...
                    <v-progress-linear v-if="loading" :indeterminate="true" class="mb-1"></v-progress-linear>
                </template>
            </dash-card>
        </div>
    </div>
