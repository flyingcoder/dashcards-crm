<template>
    <div>
        <custom-dialog :title="title" :content="textContent" :button1-text="cancelButtonText" :button2-text="confirmButtonText" :open.sync="open" @button1="cancel_clicked" @button2="confirm_clicked">
