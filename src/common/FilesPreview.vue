<template>
    <div class="files-preview">
        <!-- for videos -->
        <v-tooltip left v-if="display_videos.length > 0" v-for="(media, index) in display_videos" :key="media.id">
        ...
        <!-- for images -->
        <v-tooltip left v-if="display_medias.length > 0" v-for="(media, index) in display_medias" :key="media.id">
            <template v-slot:activator="{ on }">
        ...
        <!-- for docs -->
        <v-tooltip left v-if="display_docs.length > 0" v-for="(media, index) in display_docs" :key="media.id">
            <template v-slot:activator="{ on }">
        ...
        <!-- for others -->
        <v-tooltip left v-if="display_others.length > 0" v-for="(media, index) in display_others" :key="media.id">
            <template v-slot:activator="{ on }">
        ...
        <!-- for links -->
        <v-tooltip left v-if="display_links.length > 0" v-for="(media, index) in display_links" :key="media.id">
            <template v-slot:activator="{ on }">
