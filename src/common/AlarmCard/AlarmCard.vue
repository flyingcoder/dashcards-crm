                  ...
                  <v-sheet color="transparent">
                    ...
                    <div class="a-slide">
                      ...
                      <v-btn
                        outlined
                        dark
                        @click="open_add_participant_dialog(slide)"
                        v-if="is_owner(slide)"
                        >Invite</v-btn
                      >
                      <v-btn
                        outlined
                        dark
                        @click="open_confirm_leave_dialog(slide)"
                        v-else
                        >Leave</v-btn
                      >
                    </div>
              ...
              <v-list-item v-for="(item, i) in items" :key="item.id">
                <v-list-item-content>
                  <v-col md="6" class="body-2">
                    <v-icon small :color="item.event_type.properties.color"
                      >mdi-circle</v-icon
                    >
                    {{ item.title }}
                  </v-col>
