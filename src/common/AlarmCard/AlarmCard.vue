<template>
    <div class="timer-card">
        <div class="timer__content">
            <dash-card title="Alarm" :view-more-link="viewMoreLink" class="timer__content" :dashboard="dashboard" @close="$emit('close')" :hasAdd="true" @add="open_add_event_dialog(false)" @expand="expand">
                <div slot="content">
                                ...
                                <v-carousel-item v-for="(slide, i) in items" :key="slide.id">
                                    <v-sheet color="transparent">
                                                ...
                                                <v-menu bottom left>
                                                    ...
                                                    <v-list dense>
                                                        ...
                                                        <v-list-item :disabled="!is_owner(slide)" @click="open_event_detail_dialog(slide)">
                                                            <v-list-item-title>
                                                                <v-icon left small>pageview</v-icon>View
                                                            </v-list-item-title>
                                                        </v-list-item>
                                                    </v-list>
                                                </v-menu>
                                        ...
                                        <div class="a-slide">
                                            ...
                                            <div class="a-members">
                                                <Avatars class="a-imgs" :items="slide.participants" :count="4" :deep="true">
                                                </Avatars>
                                            </div>
            ...
            <EventTypeDialog v-if="calendar" ref="event_type_dialog" :calendar="calendar" @new-event-type-added="insert_new_event_type"></EventTypeDialog>
