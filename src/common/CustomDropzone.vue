<template>
    <div>
        <v-row>
            <v-col md="12">
                <vue-dropzone ref="dropzone" id="dropzone" :options="options" v-bind="$attrs" @vdropzone-thumbnail="$emit('thumbnail', arguments)" @vdropzone-file-added="file_is_uploaded(arguments)" @vdropzone-success="upload_success" @vdropzone-error="$emit('failed', arguments)" @vdropzone-removed-file="file_is_removed()" @vdropzone-canceled="file_is_removed()" @vdropzone-sending="file_is_sending" @vdropzone-max-files-exceeded="max_file_exceed">
                    <v-row align-center justify-center fill-height class="drop__files_content">
