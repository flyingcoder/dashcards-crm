      ...
      <div class="dialog-header">
        <div class="uploaded-info">
          <div class="client">
            ...
            <div class="b-info">
              <div class="name">Brian Howard</div>
              <div class="subname">Client</div>
            </div>
          </div>
          ...
          <div class="project">
            ...
            <div class="b-info">
              <div class="name">XYZ CRM Development</div>
      ...
      <div class="dialog-body" v-if="previewFrom === 'files'">
        <div class="left-side">
          <div class="img-controls">
            ...
            <v-btn fab small outlined class="elevation-1"
              ><v-icon>near_me</v-icon></v-btn
            >
            <v-btn fab small outlined class="elevation-1"
              ><v-icon>edit</v-icon></v-btn
            >
            <v-btn fab small outlined class="elevation-1"
              ><v-icon>text_fields</v-icon></v-btn
            >
            <v-btn fab small outlined class="elevation-1"
              ><v-icon>photo_library</v-icon></v-btn
            >
            <v-btn fab small outlined class="elevation-1"
          ...
          <div class="img-footer">
            <div class="uploaded-by">
              <v-avatar size="40">
                <img
                  :src="media.custom_properties.user.image_url"
                  :alt="media.custom_properties.user.fullname"
                />
              </v-avatar>
              <div class="b-info">
            ...
            <div class="approval">
              <v-btn class="approve mr-1">Approve</v-btn>
              <v-btn class="modif mr-1">For Modification</v-btn>
              <v-btn class="reject mr-1">Reject</v-btn>
        ...
        <div class="right-side">
          <div class="chat-controls">
            ...
            <v-btn fab small outlined><v-icon>add</v-icon></v-btn>
            <v-btn class="share-btn"><v-icon left>share</v-icon>SHARE</v-btn>
          </div>
          <div class="comments-body">
            <Comment
              ...
              :deleteApi="comment_api"
            ></Comment>
          </div>
        </div>
      </div>

      <div class="dialog-body-preview" v-if="previewFrom === 'timeline'">
        <div class="img-preview">
          <img :src="mainurl" />
        </div>
        <div class="img-footer">
