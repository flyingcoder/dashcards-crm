                        ...
                        <v-card outlined class="mx-auto">
                            <div class="friend__list">
                                <template v-if="userLoading">
                                    <v-skeleton-loader v-for="n in 5" :key="n" ref="skeleton"
                                                       type="list-item-avatar-two-line"
                                                       class="mx-auto"
                                    />
                                </template>
                                <v-list subheader dense v-if="group_list.length > 0">
                                    <v-list-item v-for="group of group_list" :key="group.id"
                                                 @click="open_conversation(group)"
                                    >
                                        <v-list-item-content>
                                            <div class="friend user" @click="open_conversation(group)">
                                                <div class="user-wrap">
                                                    <!--<div class="user__img">
                                                    ...
                                                    <Avatars class="ma-0" :items="group.users" :count="1" />
                                                    <span class="user__name">{{ group.data.group_name | ucwords }}</span>
                                                </div>
                                            </div>
                                        </v-list-item-content>
                                        <v-list-item-icon>
                                ...
                                <v-list subheader dense>
                                    <v-list-item v-for="user of sortByOnlineStatus" :key="user.id"
                                                 @click="open_conversation(user.conversation)"
                                    >
                                        <v-list-item-content>
                                            <div class="friend user" @click="open_conversation(user.conversation)">
                                                <div class="user-wrap">
                                                    <div class="user__img">
                                                    ...
                                                    <span class="user__name">{{ user.fullname | ucwords }}</span>
                                                </div>
                                            </div>
                                        </v-list-item-content>
                                        <v-list-item-icon>
