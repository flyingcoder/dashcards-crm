                ...
                <v-flex md3 sm4 xs12 class="chat__sidebar">
                    <div class="chatlist">
                        <div class="you user">
                            ...
                            >
                                <v-btn flat class="add__chat" slot="activator"><v-icon>add</v-icon></v-btn>
                                ...
                                <div class="add__chatlist">
                                    ...
                                    <div class="search">
                                        <v-text-field class="search__textfield"
                                                        solo
                                                        flat 
                                                        hide-details
                                                        prepend-icon="search"
                                    ...
                                    <div class="friend__list">
                                        ...
                                        >
                                            ...
                                            <div class="user__info">
                                                ...
                                                <div class="active__history">{{friend.activeHistory}}</div>
                                            </div>
                                        </div>
                    ...
                    <div class="message__content">
                        <v-layout row wrap class="message__header">
                            ...
                            <v-flex xs5 class="actions">
                                <v-btn dark fab flat small color="#fff"> <v-icon>email</v-icon> </v-btn>
                                <v-btn dark fab flat small color="#fff"> <v-icon>share</v-icon> </v-btn>
                                <v-btn dark fab flat small color="#fff"> <v-icon>settings</v-icon> </v-btn>
                                <v-btn dark fab flat small color="#fff"> <v-icon>close</v-icon> </v-btn>
                            </v-flex>
                        </v-layout>
