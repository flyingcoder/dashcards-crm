        ...
        >
          <template slot="custom-item" slot-scope="item">
            ...
            <td class="text-xs-left textarea-cap">
              {{ short_description_text(item.item.description) }}
            </td>
