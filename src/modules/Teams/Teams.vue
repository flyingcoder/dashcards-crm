	...
	<div class="teams-page">
		...
		>
			<template slot="toolbar">
				<v-layout row wrap justify-space-between align-center flat
					...
					<div class="member__option">
						...
						<v-btn class="groups" dark small color="#3b589e"
						       @click="go_to_groups_page">Groups
						</v-btn>
						...
						<v-menu class="sort__dropdown"
							...
							<v-list class="sort__list" flat>
								<v-list-tile class="sort__list_tile"
								             v-for="(sortLists, index) in sortList"
								             :key="index">
									<v-list-tile-title class="sort__list_item">{{ sortLists.title
										}}
									</v-list-tile-title>
								</v-list-tile>
							</v-list>
