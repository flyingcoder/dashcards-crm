    ...
    <custom-dialog :title="title" ref="dialog" :open.sync="open" button2-text="Save" @button1="cancel">
        <template slot="content">
            ...
            <v-row no-gutters v-show="!loading">
                ...
                <v-col xs="12" sm="12">
                    <v-text-field prepend-inner-icon="mdi-email-receive" class="dialog__email d-field" color="#667187"
                ...
                <v-col xs="12" sm="12" v-if="!isEditDialog">
                    <v-checkbox v-model="show_create_password" :label="show_create_password_label" hide-details
            ...
            " label="Repeat Password" :type="show_repeat_password ? 'text' : 'password'" v-model.trim="repeat_password"
        ...
        ><br /> -->
            ...
            <v-row no-gutters v-show="!loading">
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-map-marker" class="dialog__textfield d-field" color="#667187"
