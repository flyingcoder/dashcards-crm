                                    ...
                                    <draggable class="row form-drag" v-model="structures" scroll-sensitivity="300" force-fallback="true">
                                        <v-col class="row-type" @mouseover="item.hover = true" @mouseleave="item.hover = false" :class="{ active: activeType.id === item.id }" md="12" v-for="(item, pIndex) in structures" :key="item.id" @click="activeType = item">
                                            ...
                                            <div v-else-if="item.type === 'image'">
                                                ...
                                                <v-img style="max-width: 100%;" :width="item.itemwidth" :class="alignClass(item.align)" :height="item.itemheight" :src="item.src" :alt="item.alt"></v-img>
                                            </div>
                            ...
                            <v-card flat>
                                ...
                                <v-card flat tile>
                                    <v-card-text v-if="activeType">
                                        ...
                                        <v-text-field v-model="activeType.src" append-icon="mdi-cloud-upload-outline" label="Source URL *" hide-details="auto" dense filled v-if="activeType.hasOwnProperty('src')" class="mb-1"></v-text-field>
