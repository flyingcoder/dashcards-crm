                ...
                <v-card>
                    ...
                    <v-card-actions class="pb-5" v-if="!submitted">
                        <v-col md="2">
                            ...
                            <v-img :height="20" contain :src="require('@/assets/logo/buzzooka-blue.png')"></v-img>
                        </v-col>
                        <v-spacer></v-spacer>
                        <small>Never submit passwords through Buzzooka Forms.</small>
                        <v-spacer></v-spacer>
                        <v-btn v-if="form && form.status === 'active'" @click="submitForm" x-large depressed color="primary" :disabled="viewMode || submitting || disabled" :loading="submitting" class="px-5">
                            Submit <v-icon right>mdi-email-send</v-icon>
                        </v-btn>
