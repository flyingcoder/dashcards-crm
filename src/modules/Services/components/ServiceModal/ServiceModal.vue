<template>
    <custom-dialog :title="title" ref="dialog" :open.sync="open" @button1="clear_and_close" :maxWidth="700">
                ...
                <v-row no-gutters>
                    <v-col md="4" sm="12">
                        <div class="fullwidth mx-auto">
                            ...
                            <v-btn block class="mt-1" @click="$refs.uploadModal.openDialog()"><v-icon left>mdi-image-edit-outline</v-icon> Change Cover</v-btn>
