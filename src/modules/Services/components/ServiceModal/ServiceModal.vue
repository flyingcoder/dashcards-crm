            ...
            <template v-slot:content>
                <div style="height: 480px;">
                    <v-row no-gutter class="dialog__buttons">
                        ...
                        <v-col md="4" sm="6">
                            <v-menu v-model="end_date_menu" close-on-content-click transition="scale-transition"
                        ...
                        <v-col md="4" sm="6">
                            ...
                            <div class="choosen" v-if="manager.selected.length > 0">
                                <v-chip outlined class="mt-1 tile" v-for="(item, i) in manager.selected" :key="i" close
                        ...
                        <v-col md="4" sm="12">
                            ...
                            >
                                ...
                                <v-list dense>
                                    ...
                                    <v-list-item v-for="item in non_selected_members" :key="item.user_id"
                            ...
                            <div class="choosen" v-if="members.selected.length > 0">
                                <v-chip outlined class="mt-1 tile" v-for="(item, j) in members.selected" :key="j" close
                        ...
                        <v-col md="12" class="service__description">
                            <div class="service__description">
                                <Editor ref="editor" :hasFloatingTools="false" v-model="description"
                                        :content="description" placeholder="Campaign Description"
                                />
                            </div>
                        </v-col>
                    </v-row>
