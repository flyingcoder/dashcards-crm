            ...
            <v-card class="custom__dialog">
                ...
                <v-card-text style="height: 500px;">
                    <v-row no-gutter class="dialog__buttons">
                        ...
                        <v-col md="4" sm="6">
                            <v-menu v-model="start_date_menu" ref="start_date_menu" close-on-content-click transition="scale-transition" offset-y min-width="290px">
                                <template v-slot:activator="{ on }">
                                    <v-btn v-on="on" class="d__btn" block>
                                        <div class="d__icon">
                                            <svg viewBox="0 0 250 250">
                        ...
                        <v-col md="4" sm="6">
                            <v-menu v-model="end_date_menu" close-on-content-click transition="scale-transition" offset-y min-width="290px">
                                <template v-slot:activator="{ on }">
                                    <v-btn v-on="on" class="d__btn" block>
                                        <div class="d__icon">
                                            <svg viewBox="0 0 250 250">
                    ...
                    <v-row>
                        <v-col md="4" sm="12">
                            <div class="fullwidth mx-auto">
                                ...
                                <v-btn class="mt-1" @click="$refs.uploadModal.openDialog()">Change Cover</v-btn>
                            </div>
                        </v-col>
                        <v-col md="8" sm="12">
                            <v-col md="12">
                                <TextField dense :value.sync="name" label="Service Name *" color="#657186" outlined></TextField>
                            </v-col>
                            <v-col md="12" sm="12">
                                <TextField dense :value.sync="business_name" label="Business Name *" color="#657186" outlined></TextField>
                            </v-col>
                            <v-col md="12" sm="12">
...
<style lang="scss" scoped src="./ServiceModal.scss"></style>
<style lang="css" scoped>
>>>.theme--light.v-text-field--filled>.v-input__control>.v-input__slot {
    background-color: #fff;
}

>>>.service__description .ql-container {
    min-height: 120px !important;
}

>>>.service__description .quillWrapper {
    background: #fff;
}
