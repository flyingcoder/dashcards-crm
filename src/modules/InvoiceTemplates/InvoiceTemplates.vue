<template>
    <div class="invoice-templates">
        <div class="invoice-templates-wrapper">
                ...
                <template v-slot:header-toolbar>
                    <v-tooltip left>
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn fab small dark class="mx-1" color="#3b589e" v-bind="attrs" v-on="on" @click="open_add_dialog">
                    ...
                    <v-tooltip left>
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn fab small class="mx-1" color="#3b589e" v-bind="attrs" v-on="on" @click="open_help_dialog">
                                <v-icon color="#fff">mdi-help-rhombus-outline</v-icon>
                            </v-btn>
                        </template>
