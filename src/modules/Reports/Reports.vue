    ...
    <div class="reports">
        <div class="body-wrapper" v-if="reports.length > 0">
            <div class="reports-inner">
                ...
                >
                    <v-tab class="text-none" v-for="(report, i) in reports" :key="i">
                                ...
                                <v-tooltip top>
                                    <template v-slot:activator="{ on: tooltip }">
                                        <v-btn block tile text class="text-none align-self-center ma-0" v-bind="attrs"
                                               v-on="{ ...tooltip, ...menu }">
                                            <v-icon class="mr-2" color="#8090aa">mdi-plus-circle-multiple-outline
                                            </v-icon>
                                            Add Report
                                        </v-btn>
                                    </template>
        ...
        <report-via-template :isEdit="true" title="Edit Report" :report="activeReport" @save="handleUpdateReportViaTemplate"
