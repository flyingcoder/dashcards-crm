	        ...
	        <v-col md="4" >
	          <v-card >
	            <v-img
		            :height="200"
		            contain
	              src="https://cdn1.iconfinder.com/data/icons/smallicons-logotypes/32/google_drive-512.png"
	            ...
	            <v-card-actions>
	              <v-btn text block large outlined @click="handleGooglebtn"><v-icon color="success" left>mdi-google-drive</v-icon> {{ googleBtnLabel }}</v-btn>
	            </v-card-actions>
	          </v-card>
	        </v-col>
	        <v-col md="4" >
	          <v-card >
	            <v-img
		            :height="200"
		            contain
	              src="https://upload.wikimedia.org/wikipedia/commons/3/3a/Dropbox_Logo_02.svg"
	              class="white--text align-end"
	              gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
	            >
	            ...
	            <v-card-actions>
	              <v-spacer></v-spacer>
	              <v-btn text block large outlined disabled> <v-icon color="success" left>mdi-dropbox</v-icon> Coming soon! </v-btn>
	            </v-card-actions>
	          </v-card>
	        </v-col>
	      </v-row>
