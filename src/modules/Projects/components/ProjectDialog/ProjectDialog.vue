			...
			<v-card class="projects__dialog">
				...
				<div class="dialog__body">
					<v-layout row wrap class="dialog__buttons">
						...
						<v-flex sm4 xs6 class="text-xs-center">
							...
							>
								<v-btn slot="activator" class="d__btn">
									...
									<div class="d__title">Clients</div>	
								</v-btn>
						...
						<v-flex sm4 xs6 class="text-xs-center">
							...
							>
								<v-btn slot="activator" class="d__btn">
									...
									<div class="d__title">Services</div>	
								</v-btn>
						...
						<v-flex sm4 xs6 class="text-xs-center">
							...
							>
								<v-btn slot="activator" class="d__btn">
									...
									<div class="d__title">Due Date</div>	
								</v-btn>
						...
						<v-flex sm4 xs6 class="text-xs-center">
							...
							>
								<v-btn slot="activator" class="d__btn">
									...
									<div class="d__title">Members</div>	
								</v-btn>
						...
						<v-flex sm4 xs6 class="text-xs-center">
							<v-btn class="attachment d__btn"> 
								...
								<div class="d__title">Attachment</div>
							</v-btn>
						</v-flex>
				...
				<v-card-actions class="dialog__actions">
					<v-btn class="dialog__actions_btn" :disabled="disabled" @click="save">Save</v-btn>
