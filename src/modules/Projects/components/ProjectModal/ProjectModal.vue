            ...
            <v-card class="custom__dialog">
                ...
                <v-card-text class="dialog__body">
                    <v-row no-gutter class="dialog__buttons">
                        ...
                        <v-col md="4" sm="6">
                            <v-menu v-model="end_date_menu" ref="end_date_menu" close-on-content-click transition="scale-transition" offset-y min-width="290px">
                                <template v-slot:activator="{ on }">
                                    <v-btn v-on="on" class="d__btn" block>
                                        <div class="d__icon">
                                            <svg viewBox="0 0 250 250">
                    ...
                    <v-row>
                        ...
                        <v-col md="12" class="project__description">
                            <div class="project__description">
                                <Editor :hasFloatingTools="false" v-model="quill_editor.content" :content="quill_editor.content" placeholder="Project Description"></Editor>
                            </div>
                        </v-col>
