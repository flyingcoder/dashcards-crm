        ...
        <v-dialog fullscreen persistent no-click-animation hide-overlay transition="dialog-bottom-transition" v-model="view_invoice_dialog">
            <v-card class="invoice__dialog mx-auto" outlined v-if="item">
                <v-toolbar color="#3b589e" dark>
                    ...
                    <v-toolbar-title>Invoice : <span class="">{{ item.title }}</span></v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-tooltip bottom>
                        <template v-slot:activator="{ on }">
                            <v-btn v-on="on" class="mr-2" text outlined @click="downloadPDF">
                        ...
                        <v-col md="7">
                            <v-row>
                                ...
                                <v-col md="8">
                                    ...
                                    <p class="body-2">
                                        Phone : {{ item.billedFrom.telephone ? item.billedFrom.telephone.formatInternational : 'none'  }}<br />
                            ...
                            <v-row>
                                <v-col md="4">
                                    <v-img :src="item.company_logo" v-if="item.company_logo !== 'null' ">
                                        <template v-slot:placeholder>
                                            <span class="blue--text headline">No Image Available</span>
                                        </template>
                                    </v-img>
                                ...
                                <v-col md="8">
                                    ...
                                    <p class="body-2">
                                        Phone : {{ item.billedTo.telephone ? item.billedTo.telephone.formatInternational : 'none' }}<br />
