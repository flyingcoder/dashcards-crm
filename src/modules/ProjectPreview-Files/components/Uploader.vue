<template>
    <v-card flat outlined class="uploader">
        ...
        <v-progress-linear v-show="isUploading" :indeterminate="true"></v-progress-linear>
        ...
        <v-card-actions class="pa-2 actions">
            ...
            <v-btn large text outlined :disabled="isMaxFile || btnloading" @click="$refs.hidden_file_input.click()">
                <v-icon small left>mdi-file-plus</v-icon> Add Files (<small class="overline">{{folder | truncate(15)}}</small>)
            </v-btn>
