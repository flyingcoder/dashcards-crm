<template>
    <custom-dialog :title="dialogTitle" ref="dialog" :open.sync="open" button2-text="Save" @button1="cancel"
                   @button2="save" :mainBtnDisabled="!readyForSubmit"
    >
        <template slot="content">
            <v-row no-gutters class="clients__dialog">
                ...
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-account-settings-outline" class="dialog__textfield d-field"
                ...
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-account-settings-outline" class="dialog__textfield d-field"
                                  label="Last Name" v-model.trim="last_name" dense filled hide-details color="#657186"
                    />
                </v-col>
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-account-star-outline" class="dialog__textfield d-field"
                                  label="Contact Name" v-model.trim="contact_name" dense filled hide-details
                                  color="#657186"
                    />
                </v-col>
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-map-marker" class="dialog__textfield d-field" label="Location"
                                  v-model.trim="location" dense filled hide-details color="#657186"
                    />
                </v-col>
                <v-col xs="12" sm="12">
                ...
                <v-col xs="12" sm="6">
                    <v-text-field prepend-inner-icon="mdi-email-receive" class="dialog__email d-field"
                                  label="Contact Email" v-model.trim="email" dense filled hide-details color="#657186"
                    />
                </v-col>
                <v-col xs="12" sm="6">
                ...
                <v-col xs="12" sm="6" v-if="!isEditDialog">
                    <v-text-field prepend-inner-icon="mdi-account-lock-outline" class="dialog__password d-field"
                                  ...
                                  :type="show_password ? 'text' : 'password'" label="Password" v-model.trim="password"
                                  @click:append="show_password = !show_password" dense filled hide-details
                                  color="#657186"
                    />
                </v-col>
                <v-col xs="12" sm="6" v-if="!isEditDialog">
            ...
            " :type="show_repeat_password ? 'text' : 'password'" label="Repeat Password" v-model.trim="repeat_password"
                                  @click:append="show_repeat_password = !show_repeat_password" dense filled hide-details
                                  color="#657186"
                    />
                </v-col>
            </v-row>
