<template>
  <v-layout justify-center v-if="task">
    <v-dialog
      scrollable
      max-width="800"
      v-model="dialog"
    ...
    >
      <v-card>
        <v-toolbar dense dark color="#3b589e">
          <v-toolbar-title>Task Preview : {{task.title | ucwords }}</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
...
<style scoped>
  >>> .task__tab_preview_card .content__wrapper { box-shadow: none; }
</style>
