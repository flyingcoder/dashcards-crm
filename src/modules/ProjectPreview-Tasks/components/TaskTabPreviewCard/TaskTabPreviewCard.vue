      ...
      <v-card class="mx-auto" v-else-if="content && !loading">
            ...
            <v-list-item-content>
              <v-col>
                <v-list-item-title class="body-2 font-weight-medium">
                  <v-avatar color="grey">
                    <v-img
                      :src="assignee_url" height="45" width="45"
                    ></v-img>
                  </v-avatar>
          ...
          <v-card-text class="px-4">
            <v-row class="px-4" v-if="content">
              <v-col xs="12" v-if="job_title"><v-btn disabled outlined block :height="45" >{{ job_title }}</v-btn></v-col>
              <v-col xs="12" ><v-btn disabled outlined block :height="45">{{ content.status }}</v-btn></v-col>
              <v-col xs="12" ><hours-box :content="content" v-if="content.status != 'completed'" ></hours-box></v-col>
...
>>> .task__tab_preview_card .v-card.v-sheet { border-radius: 10px; }
</style>
