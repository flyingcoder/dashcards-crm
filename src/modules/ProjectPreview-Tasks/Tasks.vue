            ...
            <div class="empty-content">
                <div class="empty-svg">
                    <svg enable-background="new 0 0 431.998 431.998" version="1.1" viewBox="0 0 432 432" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <polygon points="80.102 240 80.102 256 235.82 256 251.82 240" />
                        <polygon points="80.102 288 80.102 304 187.81 304 203.81 288" />
                        ...
                        <circle cx="176.34" cy="48" r="12" />
                    </svg>
                </div>
                <div class="empty-btn">
                    <v-btn large dark color="#3b589e" @click="add_task_dialog = true">Add Task
                    </v-btn>
                </div>
            </div>
        </div>
