<template>
    <div class="add-picture">
        <CustomDialog ref="picture_dialog" title="Upload New Company Logo" button2-text="Save" @button1="cancel"
                      :open.sync="dialog"
        >
            <template #content>
                <div class="content">
                    ...
                    />
                    <CustomDropzone v-else ref="dropzone" :duplicateCheck="true" acceptedFiles="validFileType"
