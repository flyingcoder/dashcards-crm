<template>
    <div class="company-profile">
            ...
            <div class="profile-content">
                ...
                <div class="profile-logo" v-if="company">
                    <div class="user-img" @click="image_clicked">
                        <v-img contain v-if="company_logo" :src="company_logo" width="100%" height="auto" />
                    ...
                    <v-col v-else md="8" sm="12" class="offset-md-2">
                        <v-row>
                            ...
                            <v-col md="8" cols="12" class="c-field">
                                <v-text-field outlined placeholder="Name" dense class="fullwidth" hide-details solo flat
                                              v-model="company.name" :value="company.name"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Slogan</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <v-text-field outlined placeholder="Slogan" dense class="fullwidth" hide-details solo
                                              flat v-model="company.short_description"
                                              :value="company.short_description"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Long Description</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <v-textarea :rows="2" outlined placeholder="Description" dense class="fullwidth"
                                            hide-details solo flat v-model="company.long_description"
                                            :value="company.long_description"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Website</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <v-text-field outlined placeholder="Website" dense class="fullwidth" hide-details solo
                                              flat v-model="company.domain" :value="company.domain"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Company Address</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <v-text-field outlined placeholder="Address" dense class="fullwidth" hide-details solo
                                              flat v-model="company.address" :value="company.address"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Contact Number</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <vue-phone-number-input class="fullwidth" v-model="contact_number" size="md" clearable
                                                        :default-country-code="defaultCountryCode"
                                                        @phone-number-blur="telephone_on_blur" @update="showUpdate"
                                />
                            </v-col>
                            <v-col md="4" cols="12" class="c-label">Company Email</v-col>
                            <v-col md="8" cols="12" class="c-field">
                                <v-text-field outlined type="email" placeholder="Email" dense class="fullwidth"
                                              hide-details solo flat v-model="company.email" :value="company.email"
                                />
                            </v-col>
        ...
        <IconUploader :dialog="open_add_picture" :filename="filename" @uploaded-data="updateIcon" />
    </div>
</template>
