        ...
        <td>
          <v-tooltip left v-if="is_event_owner(item)">
            <template v-slot:activator="{ on }">
              <v-icon small class="mx-1" v-on="on" @click="open_delete_dialog(item)"
                >delete</v-icon
              >
            </template>
          ...
          <v-tooltip left>
            <template v-slot:activator="{ on }">
              <v-icon small class="mx-1" v-on="on" @click="open_event_detail_dialog(item)"
                >pageview</v-icon
              >
            </template>
          ...
          <v-tooltip left v-if="!is_event_owner(item)">
            <template v-slot:activator="{ on }">
              <v-icon small class="mx-1" v-on="on" @click="open_confirm_leave_dialog(item)"
